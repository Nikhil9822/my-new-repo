define([
    ...
    async run(context) {
      ...
      for (let i = 0; i < $variables.eqpnums.length; i++) {
        const restdata = await Actions.callRest(context, {
          ...
          body: {
            ...
            p_approver_comments:$variables.coments,
      ...
      if (allSuccess) {
        ...
        let obj =
        {
          ...
          "Role_Name": "OII Equipment Time Entry Approver JR"
        };
        ...
        const response4 = await Actions.callRest(context, {
          ...
          uriParams: {
            ...
            'p_request_number': $variables.selectionrow.eqp_request_number,
            'Role_name': "OII Equipment Time Entry Approver JR",
          },
        });
 ...
 const results = await ActionUtils.forEach($variables.assetsTableAdp.data, async (item, index) => {
        ...
        await Actions.fireNotificationEvent(context, {
          summary: 'The request has been approved successfully',
          type: 'confirmation',
