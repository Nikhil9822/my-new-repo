      ...
      map.on('click', (e) => {
        ...
        fetch(`https://api.mapbox.com/geocoding/v5/mapbox.places/${coordinates.lng},${coordinates.lat}.json?access_token=${mapboxgl.accessToken}`)
          ...
          .then(data => {
            ...
            $variables.zipCode = postalCode;
            $variables.location = placeName;
            $variables.longitude = coordinates.lng;
            $variables.latitude = coordinates.lat;
            $variables.addressline1 = address1;
            $variables.country = country;
            $variables.addressline2 =   address2;
            $variables.city =city;
